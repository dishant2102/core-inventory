import { Box, Checkbox, Chip, IconButton, Avatar, Stack } from '@mui/material';
...
export function AutocompleteSearchTags({
    options = [],
    value: initialValue,
    valueKey,
    labelKey,
    ...
    const handleOnChange = useCallback(
        async (_event, newValue) => {
            ...
            if (typeof newValue === 'string' || newValue?.inputValue) {
                ...
                formattedItem.id = newValue?.id;
                formattedItem.tagName = newValue?.tagName;
            ...
            if (valueKey) {
                if (multiple) {
                    ...
                    updatedValue = newCreatedValue && newCreatedValue[valueKey] ?
                        newCreatedValue[valueKey] :
                        newCreatedValue;
                }
            }
